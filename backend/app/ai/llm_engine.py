...
class LLMEngine:
    def __init__(self):
        key = settings.ai.GROQ_API_KEY.get_secret_value() if settings.ai.GROQ_API_KEY else ""
        self._api_key = key.strip()
        self._model = settings.ai.GROQ_MODEL or "llama3-70b-8192"
        self._has_key = bool(self._api_key and self._api_key != "your_groq_api_key_here")
