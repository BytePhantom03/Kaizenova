...
function LoginForm() {
  ...
  const featureBullets = [
    { icon: <BrainCircuit className="h-4 w-4 text-primary" />, text: "AI-powered evaluation" },
    { icon: <Target className="h-4 w-4 text-secondary" />, text: "Adaptive difficulty scaling" },
    { icon: <Zap className="h-4 w-4 text-warning" />, text: "Real-time feedback" },
  ];
