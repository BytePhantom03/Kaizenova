    ...
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-background">
      ...
      <main className="relative z-10">
        ...
        <section className="flex flex-col items-center justify-center px-4 sm:px-6 pt-32 sm:pt-40 pb-20">
          ...
          >
            <span className="font-medium">Trusted by <span className="text-foreground">1,200+</span> students</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {features.map((feature, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className={`group relative overflow-hidden rounded-2xl border border-border bg-card/30 p-7 backdrop-blur-sm transition-all duration-300 hover:border-border/80 hover:bg-card/50 ${feature.glow}`}
                >
        ...
        <section className="px-4 sm:px-6 py-20">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="max-w-4xl mx-auto relative rounded-3xl border border-primary/20 bg-gradient-to-br from-primary/5 via-card/30 to-secondary/5 p-10 sm:p-16 text-center overflow-hidden"
          >
            {/* Glow effects */}
